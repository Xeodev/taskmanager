...
public class TaskmanagementPersistentManager extends PersistentManager {
    private static final String PROJECT_NAME = "Taskmanagement";
    ...
    private TaskmanagementPersistentManager() throws PersistentException {
    ...
    protected void configureMetadataSources(MetadataSources aMetadataSources) {
        ...
        aMetadataSources.addAnnotatedClass(Comments.class);
        aMetadataSources.addAnnotatedClass(Task.class);
        aMetadataSources.addAnnotatedClass(Users.class);
        aMetadataSources.addAnnotatedClass(Role.class);
        aMetadataSources.addAnnotatedClass(UserRole.class);
    }
    ...
    public static synchronized final PersistentManager instance() throws PersistentException {
        if (_instance == null) {
            _instance = new TaskmanagementPersistentManager();
        }
